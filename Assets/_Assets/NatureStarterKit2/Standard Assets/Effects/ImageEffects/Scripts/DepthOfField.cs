    ...
    public class DepthOfField : PostEffectsBase {
        ...
        private void WriteCoc ( RenderTexture fromTo, bool fgDilate) {
            ...
            if (nearBlur && fgDilate) {
                ...
                RenderTexture tempRenderTexture = RenderTexture.GetTemporary(fromTo.width, fromTo.height, 0, fromTo.format);
                Graphics.Blit(fromTo, tempRenderTexture, dofHdrMaterial, 13);
                Graphics.Blit(tempRenderTexture, fromTo);
